...
export default function splash ({ path, name, org, coc, logo, active, total, channels, large, iframe }){
  let div = dom('section style="padding: 50px 0"', dom('div.container',
    ...
    dom('form id=invite',
      ...
      dom('input.form-item.input-lg type=email name=email placeholder="Email Address" style="margin-bottom: 15px;" '
        + (!iframe ? 'autofocus' : '')),
      coc && dom('.coc',
        dom('label',
