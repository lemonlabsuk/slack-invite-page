...
export default function slackin ({
  ...
  router.get('/', (req, res) => {
          ...
          dom(".collapse.navbar-collapse id='bs-example-navbar-collapse-1'",
            dom("ul.nav.navbar-nav.navbar-right",
              [
                ...
                dom("li",
                  dom("a href='//lemonlabs.io/opensource/'",
                    "Open Source"
                  )
                ),
                dom("li.page-scroll",
    ...
    let footer = dom("footer.text-center",
      [
        ...
        dom('script src="//lemonlabs.io/js/jquery-1.11.0.js"'),
        dom('script src="//lemonlabs.io/js/bootstrap.min.js"'),
        dom('script src="//lemonlabs.io/js/freelancer.js"')
      ]
    )
  ...
  // realtime
  var io = sockets(srv, {path: path + 'socket.io'})
  io.set('origins', 'https://lemonlabs.io:*')
