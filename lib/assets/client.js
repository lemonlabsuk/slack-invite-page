...
var button = body.querySelector('button.loading')
...
// realtime updates
var socket = io('https://lemonlabs-slack-invite-page.herokuapp.com', {path: '/slack/socket.io/'})
